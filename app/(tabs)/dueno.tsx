	...
	return (
		<ScrollView style={styles.screen} contentContainerStyle={{ paddingBottom:40 }}>
			<LinearGradient colors={['#064420', PRIMARY]} style={styles.hero}>
				<ThemedText style={styles.heroTitle}>Mis Micros</ThemedText>
				<ThemedText style={styles.heroSubtitle}>Resumen operativo de flota</ThemedText>
			</LinearGradient>

			<View style={styles.metricsRow}>
				<MetricCard label="Operativos" value={operativos.toString()} variant='ok' />
				<MetricCard label="Mantenimiento" value={mantenimiento.toString()} variant='warn' />
				<MetricCard label="Inactivos" value={inactivos.toString()} variant='off' />
			</View>

			<View style={styles.summaryBox}>
				<View style={styles.summaryCol}>
					<ThemedText style={styles.summaryLabel}>Pasajeros hoy</ThemedText>
					<ThemedText style={styles.summaryValue}>{pasajerosTotales}</ThemedText>
				</View>
				<View style={styles.divider} />
				<View style={styles.summaryCol}>
					<ThemedText style={styles.summaryLabel}>Ingresos hoy</ThemedText>
					<ThemedText style={styles.summaryValue}>{ingresosTotales} Bs</ThemedText>
				</View>
			</View>

			<View style={styles.sectionHeader}>        
				<ThemedText style={styles.sectionTitle}>Flota</ThemedText>
			</View>
			...
			<Pressable style={styles.addButton} onPress={()=>{/* futuro: agregar micro */}}>
				<ThemedText style={styles.addButtonTxt}>Agregar micro</ThemedText>
			</Pressable>
		</ScrollView>
	);
}
