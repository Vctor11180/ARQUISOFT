	...
	return (
		<ScrollView style={styles.screen} contentContainerStyle={{ paddingBottom: 48 }}>
			<LinearGradient colors={['#064420', PRIMARY]} style={styles.hero}>        
				...
				<ThemedText style={styles.heroTitle}>¿Qué es Tucán?</ThemedText>
				<ThemedText style={styles.heroSubtitle}>Plataforma integrada de movilidad urbana para Santa Cruz</ThemedText>
			</LinearGradient>
			...
			<Section title="Problemas que resolvemos">
			...
			<Section title="Componentes principales">
			...
			<Section title="Beneficios por rol">
				<CardGrid>
			...
			<Section title="Seguridad y confianza">
			...
			<Section title="Hoja de ruta (próximos hitos)">
			...
			<Pressable style={styles.cta} onPress={()=>router.back()}>
				<ThemedText style={styles.ctaTxt}>Volver</ThemedText>
			</Pressable>
		</ScrollView>
	);
}
