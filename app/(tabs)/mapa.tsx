  ...
  return (
    <View style={styles.root}>
      <LinearGradient colors={[DARK, PRIMARY]} style={styles.header}>
        <ThemedText style={styles.title}>{t('map.title')}</ThemedText>
      ...
      <View style={styles.mapContainer}>
        ...
        >
          <Polyline
            ...
            lineJoin="round"
          />
          <Marker coordinate={RUTA_FICTICIA[0]} title={t('map.markers.start')} description="Punto de partida" />
          <Marker coordinate={RUTA_FICTICIA[RUTA_FICTICIA.length - 1]} title={t('map.markers.destination')} description={t('map.markers.endRoute')} />
